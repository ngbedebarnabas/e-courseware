...
<html lang="en">
  <head>
    ...
    <meta property="og:description" content="An Online Resource for Undergraduates, Exam past questions and answers">
          ...
          <ul class="nav nav-navbar">
            <li class="nav-item">
              ...
              <ul class="nav">
                ...
                {{--  <li class="nav-item">
                  <a class="nav-link" href="#">Faculties <span class="arrow"></span></a>
                  <nav class="nav">
                    
                    @foreach ($faculties as $faculty)
                    <a class="nav-link" href="{{ route('facultyQuestion', $faculty->id)}}">{{ $faculty->name}} </a>
                    @endforeach
